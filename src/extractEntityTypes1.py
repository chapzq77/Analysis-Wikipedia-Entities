...
for i in range(1,12976):
        print i
        name="D:\\MSbyResearch\\webMining\\Assignment4\\as4\\wikixmlj-r43\\sampleInfoBoxes\\page"+str(i)+".txt"
...
for i in range(0,len(listOfTables)):
        ...
        output="D:\\MSbyResearch\\webMining\\Assignment4\\as4\\sampleEntities1\\" +tableName+ ".txt"
        out=open(output,"w")
        for row in rows:
...
f=open("D:\\MSbyResearch\\webMining\\Assignment4\\as4\\ListOfEntities1.txt","w")
f.write("\n".join(listOfTables))
f.close()
f=open("D:\\MSbyResearch\\webMining\\Assignment4\\as4\\NoOfEntitiesForEachEntityType.txt","w")
for dict in dictionary:
    f.write(str(dict))
    f.write(":")
    f.write(str(dictionary[dict]))
    f.write("\n")
f.close()
